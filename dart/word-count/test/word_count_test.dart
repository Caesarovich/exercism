...
void main() {
  ...
  group('WordCount', () {
    ...
    test('with apostrophes', () {
      ...
      expect(result, equals(<String, int>{'first': 1, 'don\'t': 2, 'laugh': 1, 'then': 1, 'cry': 1, 'you\'re': 1, 'getting': 1, 'it': 1}));
    }, skip: false);
    ...
    test('substrings from the beginning', () {
      ...
      expect(result, equals(<String, int>{'joe': 1, 'can\'t': 1, 'tell': 1, 'between': 1, 'app': 1, 'apple': 1, 'and': 1, 'a': 1}));
    }, skip: false);
