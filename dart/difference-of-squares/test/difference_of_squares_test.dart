...
void main() {
  group('DifferenceOfSquares: Square the sum of the numbers up to the given number - ', squareTheSumOfTheNumbersUpToTheGivenNumber);
  group('DifferenceOfSquares: Sum the squares of the numbers up to the given number - ', sumTheSquaresOfTheNumbersUpToTheGivenNumber);
