...
def add_me_to_the_queue(express_queue: Queue, normal_queue: Queue, ticket_type: Literal[0, 1], person_name: str) -> Queue:
    ...
    queue: Queue = normal_queue if ticket_type == 0 else express_queue
...
def add_me_with_my_friends(queue: Queue, index: int, person_name: str) -> Queue:
